  ...
  <aside class="hidden md:flex flex-col w-64 bg-white border-r border-gray-100 h-screen sticky top-0">
    ...
    <div class="flex-1 overflow-y-auto px-4 py-2 space-y-1">
      <router-link v-for="item in navItems" :key="item.path" :to="item.path" 
                   class="flex items-center gap-3 px-4 py-3 text-gray-600 rounded-xl hover:bg-primary-50/50 hover:text-primary-600 transition-all duration-300"
                   active-class="bg-primary-50 text-primary-700 font-semibold shadow-sm">
      ...
      <div class="my-4 pt-4 border-t border-gray-100">
        ...
        <router-link v-for="item in exploreItems" :key="item.path" :to="item.path" 
                     class="flex items-center gap-3 px-4 py-2.5 text-gray-600 rounded-xl hover:bg-gray-50/80 hover:text-gray-900 transition-all duration-300"
                     active-class="bg-primary-50 text-primary-700 font-semibold shadow-sm">
